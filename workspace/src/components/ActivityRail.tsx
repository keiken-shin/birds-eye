    ...
    <div className="flex w-[54px] flex-none flex-col items-center gap-[5px] border-r border-line bg-panel pt-3">
      {top.map((b) => (
        <button
          ...
          onClick={b.onClick}
          className={
            "flex h-[38px] w-[38px] items-center justify-center rounded-[9px] text-[17px] " +
            (b.active
      ...
      <button
        ...
        className="mt-auto flex h-[38px] w-[38px] items-center justify-center rounded-[9px] text-[15px] text-faint hover:text-ink"
      >
        ?
      </button>
      <button
        ...
        className="mb-3 flex h-[38px] w-[38px] items-center justify-center rounded-[9px] text-[17px] text-faint hover:text-ink"
      >
        ⚙
      </button>
    </div>

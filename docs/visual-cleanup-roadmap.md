...
- [ ] Customizable layout: let users reorder, hide, and resize workbench panels.
  First pass exists: cleanup sidebar panels plus detail/simulation/duplicates/review sections can be hidden with toggles, but reordering and resizing remain pending.
